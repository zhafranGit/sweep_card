...
import 'package:untitled/card_view.dart';
          ...
          SwipeableCardsSection(
            ...
            onCardSwiped: (dir, index, widget) {
              ...
              if (dir == Direction.left) {
                print('kiri ${(widget as CardView).text} $index');
              } else if (dir == Direction.right) {
                print('kanan ${(widget as CardView).text} $index');
              } else if (dir == Direction.up) {
                print('atas ${(widget as CardView).text} $index');
              } else if (dir == Direction.down) {
                print('bawah ${(widget as CardView).text} $index');
              }
            },
            enableSwipeUp: true,
